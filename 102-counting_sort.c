 ...
 * The counting sort algorithm sorts an array by counting the number of occurrences of each unique element in the array
 * and then using those counts to calculate the positions of each element in the sorted array.
 */
